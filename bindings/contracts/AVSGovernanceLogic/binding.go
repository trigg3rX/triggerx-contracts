...
func DeployContractAVSGovernanceLogic(auth *bind.TransactOpts, backend bind.ContractBackend, _endpoint common.Address, _proxyHub common.Address, _dstEid uint32, _ownerAddress common.Address, _avsGovernance common.Address) (common.Address, *types.Transaction, *ContractAVSGovernanceLogic, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(ContractAVSGovernanceLogicBin), backend, _endpoint, _proxyHub, _dstEid, _ownerAddress, _avsGovernance)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
type ContractAVSGovernanceLogicCalls interface {
	...
	ProxyHub(opts *bind.CallOpts) (common.Address, error)
}
...
type ContractAVSGovernanceLogicTransacts interface {
	...
	SetProxyHub(opts *bind.TransactOpts, _proxyHub common.Address) (*types.Transaction, error)
...
// ProxyHub is a free data retrieval call binding the contract method 0xf0b351d9.
//
// Solidity: function proxyHub() view returns(address)
func (_ContractAVSGovernanceLogic *ContractAVSGovernanceLogicCaller) ProxyHub(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ContractAVSGovernanceLogic.contract.Call(opts, &out, "proxyHub")
...
//
// Solidity: function proxyHub() view returns(address)
func (_ContractAVSGovernanceLogic *ContractAVSGovernanceLogicSession) ProxyHub() (common.Address, error) {
	return _ContractAVSGovernanceLogic.Contract.ProxyHub(&_ContractAVSGovernanceLogic.CallOpts)
}

// ProxyHub is a free data retrieval call binding the contract method 0xf0b351d9.
//
// Solidity: function proxyHub() view returns(address)
func (_ContractAVSGovernanceLogic *ContractAVSGovernanceLogicCallerSession) ProxyHub() (common.Address, error) {
	return _ContractAVSGovernanceLogic.Contract.ProxyHub(&_ContractAVSGovernanceLogic.CallOpts)
}
...
// SetProxyHub is a paid mutator transaction binding the contract method 0x96e51b9c.
//
// Solidity: function setProxyHub(address _proxyHub) returns()
func (_ContractAVSGovernanceLogic *ContractAVSGovernanceLogicTransactor) SetProxyHub(opts *bind.TransactOpts, _proxyHub common.Address) (*types.Transaction, error) {
	return _ContractAVSGovernanceLogic.contract.Transact(opts, "setProxyHub", _proxyHub)
}

// SetProxyHub is a paid mutator transaction binding the contract method 0x96e51b9c.
//
// Solidity: function setProxyHub(address _proxyHub) returns()
func (_ContractAVSGovernanceLogic *ContractAVSGovernanceLogicSession) SetProxyHub(_proxyHub common.Address) (*types.Transaction, error) {
	return _ContractAVSGovernanceLogic.Contract.SetProxyHub(&_ContractAVSGovernanceLogic.TransactOpts, _proxyHub)
}

// SetProxyHub is a paid mutator transaction binding the contract method 0x96e51b9c.
//
// Solidity: function setProxyHub(address _proxyHub) returns()
func (_ContractAVSGovernanceLogic *ContractAVSGovernanceLogicTransactorSession) SetProxyHub(_proxyHub common.Address) (*types.Transaction, error) {
	return _ContractAVSGovernanceLogic.Contract.SetProxyHub(&_ContractAVSGovernanceLogic.TransactOpts, _proxyHub)
}
