...
contract TriggerXDeployerHolesky is Script {
    ...
    function writeDeploymentToJson(TriggerXContracts memory triggerXContracts) internal {
        string memory jsonString = string.concat(
            ...
            '"indexRegistry": "', vm.toString(address(triggerXContracts.indexRegistry)), '",',
            '"indexRegistryImplementation": "', vm.toString(address(triggerXContracts.indexRegistryImplementation)), '",',
            '"stakeRegistry": "', vm.toString(address(triggerXContracts.stakeRegistry)), '",',
            '"stakeRegistryImplementation": "', vm.toString(address(triggerXContracts.stakeRegistryImplementation)), '",',
            '"apkRegistry": "', vm.toString(address(triggerXContracts.apkRegistry)), '",',
            '"apkRegistryImplementation": "', vm.toString(address(triggerXContracts.apkRegistryImplementation)), '",',
            '"socketRegistry": "', vm.toString(address(triggerXContracts.socketRegistry)), '",',
