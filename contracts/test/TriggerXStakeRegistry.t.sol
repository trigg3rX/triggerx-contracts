...
contract TriggerXStakeRegistryTest is Test {
    ...
    function test_Stake() public {
        ...
        // Check stake was recorded correctly
    ...
    function test_ClaimETHForTG() public {
        ...
        (uint256 amount, uint256 tgBalance) = stakeRegistry.getStake(user1);
        assertEq(amount, stakeAmount); // Stake amount unchanged
        assertEq(tgBalance, stakeAmount * 1000 - tgAmount); // TG balance decreased
    ...
    function test_UpdateTGBalances_OnlyOwner() public {
        ...
        // Update to use the custom error from OwnableUpgradeable
